    ...
    public class Config {
        ...
        public void LoadConfig(string filePath) {
            if (string.IsNullOrWhiteSpace(filePath) || !File.Exists(filePath)) {
                ...
                if (data == null) {
                    Logger.Error("Failed to restore default configration.");
                    return;
                }
                Current = data;
            }
        ...
        public class ConfigData {
            ...
            public int MessageBufferSizePerClient { get; set; }
            ...
            public static ConfigData? RestoreDefault() {
                ConfigData configData = new() {
                    ...
                    Port = 21370,
                    EOM = "<|EOM|>",
                    MessageBufferSizePerClient = 10 * 1024 * 1024,
                    MaxQueueSize = 100,
                };
                ...
                if (directory == null) {
                    Logger.Error("Failed to create directory for configuration file.");
                    return null;
                }
